...
const LATEST_CODE = 42;
const APK_URL = 'https://github.com/12362aa/chess/releases/download/v4.2-b42/chess-amkh-4.2-b42.apk';
const NOTES_AR = 'شاشةُ الترحيب صار بطلُها بيدقًا لامعًا يقفز على أرضيّةٍ عاكسة وحوله بريقٌ يلمع، بصوتِ هبوطٍ ناعم مع كلّ قفزة، ومبدّلُ اللغة لم يعد يُقصّ من أعلى الشاشة. وواجهةُ اللعب ضدّ المحرّك وُلدت من جديد «غوصًا في المحيط»: شاشةٌ كاملةٌ غامرة تنزل من السطح المشمس إلى قاع الخندق بأشعّةٍ وفقاعاتٍ وثلجٍ بحريّ وأسماكٍ تعبر وأعشابٍ تتمايل، وعشرُ محطّاتِ عمقٍ تغوص أعمق فأعمق لكلٍّ منطقتُها وقوّتُها، وبوّابةُ غوصٍ متوهّجة تفتح المواجهة بصوتِ ماء — وصورةُ Stockfish الجديدة في قلب المشهد. وأصبح في مباراة المحرّك مدرّبٌ يعلّق ويشجّع فلم تعد صامتة. وأُضيفت بطاقةُ «المتجر» بجوار الألغاز — عناصرُ وأطقمٌ قريبًا. وفي الألغاز صار زرُّ «راجع لغز اليوم» يعرض الحلّ كاملًا نقلةً نقلة مع شرح نور، ولم تعد الرقعةُ تتزحزح حين يتكلّم نور أو يصمت. وضُبطت الرئيسيّةُ على الأجهزة اللوحيّة فلم تعد البطاقاتُ تتراكب مع تحدّيات اليوم. وأُصلح فتحُ الملفّ الشخصيّ عند الضغط على المايك، وتطابقُ نسبةِ التقدّم مع صورة نور.';
const NOTES_EN = 'The welcome screen now has a glossy pawn that hops on a reflecting floor amid twinkling sparkles, with a soft landing sound on every bounce — and the language switch no longer gets clipped at the top. The play-vs-engine screen is reborn as an “ocean dive”: a full immersive screen descending from the sunlit surface to the trench floor, with light rays, bubbles, marine snow, drifting fish and swaying kelp, ten depth stations that sink deeper and deeper each with its own zone and strength, and a glowing dive gate that opens the match with a water sound — the new Stockfish artwork at the heart of it all. Engine games are no longer silent: a coach now comments and cheers you on. A “Store” card joins the puzzles — items and sets, coming soon. In puzzles, “Review today’s puzzle” now plays the full solution move by move with Nour’s commentary, and the board no longer shifts when Nour speaks or falls silent. The home screen is fixed on tablets so the cards no longer overlap today’s challenges. And pressing the mic no longer opens your profile, while the progress ring no longer covers Nour’s portrait.';
