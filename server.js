...
app.get('/api/version', (req, res) => {
  res.json({
    ...
    url: APK_URL,
    mandatory: false,
    notes: 'صار لكلمة السر المنسيّة طريق للعودة: رمز يصل إلى بريدك يعيد إليك حسابك، وإنشاء الحساب اليدوي يمرّ بتوثيق البريد برمز كذلك. وفي المكالمات صار زرّ مكبّر الصوت حقيقيًا يبدّل مسار الصوت فعلًا ولا يعلن حالة لم تتحقّق، وأُضيفت ترقية المكالمة الصوتية إلى فيديو داخل المكالمة نفسها بطلبٍ يقبله الطرف الآخر أو يرفضه، مع تبديل الكاميرا وإغلاقها. وعاد سجلّ المكالمة إلى موضعه الزمني الصحيح في المحادثة بعد أن كان يقفز إلى أسفلها دائمًا، وصارت التفاعلات تفتح لوحة الرموز كاملة بزرّ «+» بدل ستّة رموز، وظهرت قائمة الإشارة إلى الأصدقاء بحجم قابل للاستخدام تحت لوحة المفاتيح. وتظهر شاشة الترحيب أوّلًا وفورًا في أوّل تشغيل بحركة شطرنج وبثيم جهازك، وصارت التحدّيات اليومية والإحصاءات تُحصي كلّ مباراة لا مباراة واحدة في كلّ تشغيل، وأصبح إعداد «من يمكنه دعوتي لمباراة» مُطبَّقًا فعلًا. وتُعرض المباراة المُشاهَدة بثيم اللاعب المُشاهَد ورقعته وقطعه، وصار نور يعرف لونه دائمًا ولا ينسب قطع خصمه لنفسه ويعلّق على المباراة بتنويعٍ مبنيّ على أحداثها، وضُبط تصنيف النقلات في المراجعة فلم تعد «رائعة» توزَّع في مباراة عادية.',
  });
});
