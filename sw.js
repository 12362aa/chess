...
const STATIC_ASSETS = [
  ...
  './icon_v2.png?v=3',
  './nour.png',
  /* عَلَما اللغتين في الإعدادات: ملفّان لا ترميز داخلي، فلو غابا في وضع
     عدم الاتصال ظهرت بطاقتا اللغة بلا صورة. */
  './flag-sa.svg?v=20260916-b37',
  './flag-us.svg?v=20260916-b37',
