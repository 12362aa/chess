...
const tag = 'v3.10';
const releaseName = 'شطرنج Am-Kh v3.10 — مكالمات موثوقة + تحسينات الشات';
const releaseBody = [
  '♟ **شطرنج Am-Kh v3.10** (بناء 21)',
  '',
  '- 🎥 مكالمة الفيديو بتوصل فيديو فعلاً للطرف التاني (مش صوت)، وإشعارها بقى مميّز عن الصوت.',
  '- 📞 أزرار «رد/رفض» في إشعار المكالمة بتشتغل فعليًا والتطبيق مقفول (رد = قبول ودخول فوري، رفض = إنهاء).',
  '- ✨ تقليل قوي لوميض/نطّ الشاشة عند فتح وقفل الكيبورد في كل الثيمات.',
  '',
