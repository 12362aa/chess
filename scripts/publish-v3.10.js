...
const tag = 'v3.10';
const releaseName = 'شطرنج Am-Kh — محرّك أقوى + تحديات يومية + إشعارات ذكية';
const releaseBody = [
  '♟ **شطرنج Am-Kh** — تحديث جديد (بناء 23)',
  '',
  '- 🧠 **محرّك شطرنج أقوى بمراحل** — Stockfish 18 بشبكة عصبية كاملة (NNUE الكبيرة). تحليل ولعب بمستوى عالمي، مع سقوط تلقائي للنسخة الأخف على الأجهزة المحدودة عشان يفضل شغّال في كل الأحوال.',
  '- 🎯 **تحديات اليوم** — تحديات يومية ذكية تتولّد تلقائيًا وتشمل كل أوضاع اللعب (أونلاين، محرّك، بلوتوث، نور، لاعبان)، مع تتبّع الإنجاز وسلسلة الأيام المتتالية.',
  '- 🔔 **إشعارات ذكية** — الإشعارات بقت تتكيّف مع نشاطك فعلًا بدل الرسائل الثابتة المكرّرة.',
  '- 🏴 **علم دولتك محفوظ** — العلم بيفضل زي ما هو حتى بعد تسجيل الخروج والدخول من تاني.',
  '- 💬 **الشات على التابلت** — إصلاح الفراغ فوق الكيبورد وقت الكتابة.',
  '- 🧹 تنظيف الثيمات وضبط أداء عام.',
  '',
