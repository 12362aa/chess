...
const tag = 'v3.10';
const releaseName = 'شطرنج Am-Kh v3.10 — مكالمات صوتية + توقيت المباريات';
const releaseBody = [
  '♟ **شطرنج Am-Kh v3.10**',
  '',
  '- 🎙️ مكالمات صوتية (فردي + حفلة) بتقنية WebRTC مع واجهة حسب ثيم التطبيق.',
  '- ⏱️ توقيت للمباريات الأونلاين والفوز بالنقاط عند نفاد الوقت.',
  '- 💬 تحسينات الشات (ردود، تثبيت، معلومات الرسالة، سجل غير متصل).',
  '- 🔔 إشعار "تحديث جديد متاح" داخل التطبيق.',
  '',
