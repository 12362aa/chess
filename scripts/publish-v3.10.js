...
const tag = 'v3.10';
const releaseName = 'شطرنج Am-Kh — عربية فصحى في كل النصوص + تنسيق دردشة المباراة';
const releaseBody = [
  '♟ **شطرنج Am-Kh** — تحديث جديد (بناء 24)',
  '',
  '- 🗣 **عربية فصحى في كل التطبيق** — أُعيدت صياغة جميع النصوص الظاهرة للمستخدم بالعربية الفصحى: الإشعارات الذكية، إشعارات التحديث، الأصدقاء والحفلات، المحادثات، المكالمات، تسجيل الدخول، واللعب عبر البلوتوث. وصياغة الأعداد صحيحة نحويًا (واحد / اثنان / 3–10 / 11 وأكثر).',
  '- 💬 **تنسيق دردشة المباراة** — أُزيل الفراغ الفارغ بين صفّ الأزرار وصندوق الدردشة، وصار الصندوق يرتفع مع لوحة المفاتيح بتمديد الصفحة والتمرير، فلم يعد يعلو فوق الرقعة. مطبَّق على الهاتف واللوح الرقمي في جميع الأوضاع (نور والأونلاين).',
  '- 🧠 **محرّك Stockfish 18 بالشبكة العصبية الكاملة** — لعب وتحليل بمستوى عالٍ، مع تحوّل تلقائي إلى النسخة الأخف على الأجهزة المحدودة.',
  '- 🎯 **تحديات اليوم** وسلسلة الأيام المتتالية، لكل أوضاع اللعب.',
  '',
