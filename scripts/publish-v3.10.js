...
const tag = 'v3.10';
const releaseName = 'شطرنج Am-Kh — إصلاح الدخول بحساب جوجل + عربية فصحى في كل النصوص';
const releaseBody = [
  '♟ **شطرنج Am-Kh** — تحديث جديد (بناء 25)',
  '',
  '- 🔑 **إصلاح الدخول بحساب جوجل** — كان الدخول يفشل في النسخة الموقّعة للنشر لأن بصمة مفتاح التوقيع الجديد لم تكن مسجّلة لدى جوجل. سُجّلت البصمة، فعاد الدخول يعمل.',
  '- 🗣 **رسائل عربية واضحة عند تعذّر الدخول** — كان الزرّ يفشل صامتًا على بعض الأجهزة، أو يعرض نصًّا إنجليزيًّا طويلًا موجّهًا للمطوّر. صار يعرض سببًا عربيًّا مختصرًا وما ينبغي فعله.',
  '- 🗣 **عربية فصحى في كل التطبيق** — جميع النصوص الظاهرة للمستخدم بالعربية الفصحى: الإشعارات الذكية، إشعارات التحديث، الأصدقاء والحفلات، المحادثات، المكالمات، تسجيل الدخول، واللعب عبر البلوتوث.',
  '- 💬 **تنسيق دردشة المباراة** — لا فراغ بين صفّ الأزرار وصندوق الدردشة، والصندوق يرتفع مع لوحة المفاتيح دون أن يعلو فوق الرقعة، على الهاتف واللوح الرقمي.',
  '- 🧠 **محرّك Stockfish 18 بالشبكة العصبية الكاملة** — مع تحوّل تلقائي إلى النسخة الأخف على الأجهزة المحدودة.',
  '',
